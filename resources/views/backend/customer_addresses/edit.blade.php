...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Edit Customer Address {{ $customer_address->name }}</h6>
            <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.customer_addresses.update', $customer_address->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row mt-2">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="customer_name"
                                value="{{ $customer_address->user->full_name }}" class="form-control" readonly>
                            <input type="hidden" name="user_id" id="user_id" class="form-control"
                                value="{{ $customer_address->user->id  }}" readonly>
                        ...
                        <select name="country_id" class="form-control" id="country_id">
                            ...
                            @forelse ($countries as $country)
                                <option value="{{ $country->id }}"
                                    {{ old('country_id', $customer_address->country_id) == $country->id ? 'selected' : null }}>{{ $country->name }}
                                </option>
                            @empty
                            @endforelse
                        </select>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="zip_code" value="{{ old('zip_code', $customer_address->zip_code) }}" class="form-control"
                                max="99999" min="0">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="po_box" value="{{ old('po_box', $customer_address->po_box) }}" class="form-control"
                                max="9999" min="0">
    ...
    <script>
        $(function() {
            ...
            function populateStates() {
                ...
                $.get("{{ route('admin.customers.get_state_customerSearch') }}", {
            ...
            function populateCities() {
                ...
                $.get("{{ route('admin.customers.get_city_customerSearch') }}", {
                    state_id: stateIdVal
                }, function(data) { //هعمل فانكشن واديها قيمه الدوله كمتغير فيها
