                ...
                <div class="modal-body p-0">
                    <div class="row align-items-stretch">
                        <div class="col-lg-6 p-lg-0"><a class="product-view d-block h-100 bg-cover bg-center"
                                ...
                                data-lightbox="productview"></a><a class="d-none" href="{{ asset('frontend/img/product-5-alt-2.jpg') }}"
                                ...
                                <tr>
                                    <th class="pl-0 border-0" scope="row">
                                        <div class="media align-items-center"><a
                                                class="reset-anchor d-block animsition-link" href="{{ route('frontend.detail') }}"><img
                                ...
                                <tr>
                                    <th class="pl-0 border-light" scope="row">
                                        <div class="media align-items-center"><a
                                            ...
                                            <div class="media-body ml-3"><strong class="h6"><a
                                                        class="reset-anchor animsition-link" href="{{ route('frontend.detail') }}">Apple
                                                        watch</a></strong></div>
                                        </div>
                                    </th>
